...
export const Timer = (props) => {
    ...
    >
        ...
        <View style={styles.timerView}>
            <TouchableOpacity onPress={() => setTimerModalVisible(false)}><Text style={styles.XcloseIcon}>X</Text></TouchableOpacity>
            <View style={{ alignItems: "center" }}>
                ...
                <Text>
                    ...
                    <TouchableOpacity onPress={() => resetButton()}><Image source={stopicon} style={[styles.timerIcons, { marginLeft: 5, marginRight: 5 }]} /></TouchableOpacity>
    ...
    return (
        timerModalVisible ? timerModal :
            <View style={{ flex: 1, flexDirection: "row", justifyContent: "space-evenly" }}>
                ...
                <TouchableOpacity onPress={() => pauseButton()}><Image style={[styles.timerIcons, { marginTop: 1 * scale }]} source={paused ? playicon : pauseicon} /></TouchableOpacity>

                <TouchableOpacity onPress={() => setTimerModalVisible(!timerModalVisible)}>
                    <Text style={{ fontSize: 30, fontFamily: "Raleway-Bold", color: "#9f3201" }}>
                        {minutes < 10 ? `0${minutes}` : minutes}:{seconds < 10 ? `0${seconds}` : seconds}
                    </Text>
                </TouchableOpacity>


                <TouchableOpacity onPress={() => resetButton()}><Image source={stopicon} style={[styles.timerIcons, { marginTop: 1 * scale }]} /></TouchableOpacity>
            </View>
